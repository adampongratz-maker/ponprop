...
export default function CalendarPage() {
  ...
  const addEvent = useMutation({
    ...
    onSuccess: () => {
      ...
      setForm({ ...form, title: "", property: "", unit: "", notes: "" });
      setOpen(false);
  ...
  const deleteEvent = useMutation({
    ...
    onSuccess: () => { qc.invalidateQueries({ queryKey: ["calendar_events"] }); toast.success("Event removed"); },
    onError: (e: Error) => toast.error(e.message),
  });
    ...
    <div className="max-w-6xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground text-sm">Property events, inspections, lease dates, vendor visits.</p>
        </div>
        <Dialog open={open} onOpenChange={setOpen}>
          ...
          <DialogContent>
            ...
            <div className="space-y-3">
              ...
              <Button onClick={() => addEvent.mutate()} disabled={addEvent.isPending} className="w-full">
                {addEvent.isPending ? "Saving..." : "Save"}
              </Button>
            </div>
          </DialogContent>
        </Dialog>
        ...
        <Card className="glass">
          <CardContent className="p-4">
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  <TableHead>Date</TableHead><TableHead>Time</TableHead><TableHead>Title</TableHead>
                  <TableHead>Type</TableHead><TableHead>Property</TableHead><TableHead>Status</TableHead><TableHead></TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
